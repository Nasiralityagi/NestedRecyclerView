package com.nesstech.metube.paginate;

import android.support.v7.widget.RecyclerView;

import com.nesstech.metube.paginate.recycler.RecyclerPaginate;
...
public abstract class Paginate {
    ...
    public interface Callbacks {
         ...
         * {@link com.nesstech.metube.paginate.Paginate.Callbacks#onLoadMore} won't be called.
         *
         ...
         * com.nesstech.metube.paginate.Paginate.Callbacks#onLoadMore} won't be called and loading row, if used, won't be added.
         *
     ...
     * @return {@link com.nesstech.metube.paginate.recycler.RecyclerPaginate.Builder}
     */
