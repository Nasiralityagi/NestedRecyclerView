 ...
 */
package com.nesstech.metube.github.pedrovgs;
...
import com.nesstech.metube.github.pedrovgs.nineandroid.view.ViewHelper;
...
public class DraggableView extends RelativeLayout {
    ...
    public void setBackStack(String mBackStack) {
        this.mBackStack = mBackStack;
    }
    ...
    void changeSecondViewAlpha() {
        float offset = getVerticalDragOffset() - 0.3500f;//nasir modified alpha
        ViewHelper.setAlpha(secondView, 1 - offset);
    }
